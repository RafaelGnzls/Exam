...
<body>
    ...
    <div class="container">
        <h1>See the Registration Rules</h1>
        <hr>
        <div class="form">
        ...
        <form action="add.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input type="password" class="form-control"  placeholder="name@example.com" name="Password">
                <label for="floatingInput">Enter Password</label>
            </div>
            <div class="form-floating mb-3">
                <input type="password" class="form-control"  placeholder="name@example.com" name="Confirmpass">
        ...
        <div class="return">
            <span class="align-baseline">Return to the <a href="index.php">LOGIN PAGE</a></span>
        </div>
    </div>
